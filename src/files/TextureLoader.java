...
public class TextureLoader {
     ...
     */
    private HashMap<String, ArrayList<Texture>> table = new HashMap();
    /**
     ...
     */
    public ArrayList<Texture> getTexture(String resourceName, int n) throws IOException {
        ArrayList<Texture> tex = table.get(resourceName);
        if (tex != null) {
            return tex;
        }
        tex = getTexture(resourceName, n,
     ...
     * @throws IOException Indicates a failure to access the resource
     */
    public ArrayList<Texture> getTexture(String resourceName, int n, int target, int dstPixelFormat, int minFilter, int magFilter) throws IOException {
        int srcPixelFormat;
     ...
     */
    private ArrayList<BufferedImage> loadImage(String ref, int n) {
